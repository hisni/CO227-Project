        ...
        return (
            <div className={classes.Page}>
                <div className={classes.Signup}>
                    <h3>Create Accounts for Public Health Inspectors</h3>
                    {redirect}
...
const mapStateToProps = state => {
    return {
        ...
        signUpSuccess: state.adminAuth.adminSignUpSuccess
    };
};

const mapDispatchToProps = dispatch => {
    return {
        onAuth: ( data, isSignup ) => dispatch( actions.adminAuthSignUp( data, isSignup ) ),
